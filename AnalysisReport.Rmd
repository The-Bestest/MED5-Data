...
ggplot(dfSummary,aes(x=SoO,y=SoA, colour=Level, fill=Level))+
...
ggplot(dfSummary,aes(x=SoO,y=Frustration, colour=Level, fill=Level))+
  geom_point(position=position_jitter(h=0.08, w=0.08), shape = 21, alpha = 0.5, size = 3) +
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
  xlab(label = "SoO") +
...
ggplot(dfSummary,aes(x=SoO,y=Proprioception, colour=Level, fill=Level))+
  geom_point(position=position_jitter(h=0.08, w=0.08), shape = 21, alpha = 0.5, size = 3) +
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
  xlab(label = "SoO") +
...
ggplot(dfSummary,aes(x=SoA,y=Frustration, colour=Level, fill=Level))+
  geom_point(position=position_jitter(h=0.08, w=0.08), shape = 21, alpha = 0.5, size = 3) +
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
  xlab(label = "SoA") +
...
ggplot(dfSummary,aes(x=SoA,y=Proprioception, colour=Level, fill=Level))+
  geom_point(position=position_jitter(h=0.08, w=0.08), shape = 21, alpha = 0.5, size = 3) +
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
  xlab(label = "SoA") +
...
ggplot(dfSummary,aes(x=Proprioception,y=Frustration, colour=Level, fill=Level))+ 
  geom_point(position=position_jitter(h=0.08, w=0.08), shape = 21, alpha = 0.5, size = 3) +
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
...
ggplot(dfSummary,aes(x=accPerc,y=SoO, colour=Level, fill=Level))+
...
ggplot(dfSummary,aes(x=accPerc,y=SoA, colour=Level, fill=Level))+
  geom_point(position=position_jitter(h=0.1, w=0.0), shape = 21, alpha = 0.5, size = 3) +
  expand_limits(x=c(0,1), y=c(1, 7))+
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
...
ggplot(dfSummary,aes(x=accPerc,y=Frustration, colour=Level, fill=Level))+
  geom_point(position=position_jitter(h=0.1, w=0.0), shape = 21, alpha = 0.5, size = 3) +
  expand_limits(x=c(0,1), y=c(1, 7))+
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
...
ggplot(dfSummary,aes(x=accPerc,y=Proprioception, colour=Level, fill=Level))+
  geom_point(position=position_jitter(h=0.1, w=0.0), shape = 21, alpha = 0.5, size = 3) +
  expand_limits(x=c(0,1), y=c(1, 7))+
  scale_color_manual(values=c("red","blue")) +
  scale_fill_manual(values=c("red","blue")) +
...
MBlocks <- dfSummary %>% filter(Level=="Blocks")
MBody <- dfSummary %>% filter(Level=="Body")

#Median: I manually changed X
median(MBlocks$Proprioception , trim = 0, na.rm = FALSE)
median(MBody$Proprioception , trim = 0, na.rm = FALSE)

#Performance
  #boxplot
ggplot(dfSummary, aes(accPerc, y=Level, fill=Level)) + 
  coord_flip() + 
  scale_fill_manual(values=c("red","blue"))+
  ylab(label = "Level") +
  xlab(label = "Performance(%)") +
  ...
  #Histogram
ggplot(dfSummary,aes(accPerc, fill=Level))+
   scale_fill_manual(values=c("red","blue"))+
   xlab(label = "Performance") +
   ylab(label = "Fequency") +
...
#SoO
  #Histogram
ggplot(dfSummary,aes(SoO, fill=Level),xlab=7,ylab=7)+
   scale_fill_manual(values=c("red","blue"))+
   xlab(label = "SoO") +
   ylab(label = "Fequency") +
   geom_histogram(alpha=0.5,bins=14,position="identity")
  #boxplot
ggplot(dfSummary, aes(SoO, y=Level, fill=Level)) + 
  coord_flip() + 
  xlab(label = "SoO") +
  ylab(label = "Level") +
  scale_fill_manual(values=c("red","blue"))+
...
#SoA
  #Histogram
ggplot(dfSummary,aes(SoA, fill=Level),xlab=7,ylab=7)+
   scale_fill_manual(values=c("red","blue"))+
   xlab(label = "SoA") +
   ylab(label = "Fequency") +
   geom_histogram(alpha=0.5,bins=14,position="identity")
  #boxplot
ggplot(dfSummary, aes(SoA, y=Level, fill=Level)) + 
  coord_flip() + 
  xlab(label = "SoA") +
  ylab(label = "Level") +
  scale_fill_manual(values=c("red","blue"))+
...
#Frustation
  #Histogram
ggplot(dfSummary,aes(Frustration, fill=Level),xlab=7,ylab=7)+
   scale_fill_manual(values=c("red","blue"))+
   xlab(label = "Frustration") +
   ylab(label = "Fequency") +
   geom_histogram(alpha=0.5,bins=14,position="identity")
  #boxplot
ggplot(dfSummary, aes(Frustration, y=Level, fill=Level)) + 
  coord_flip() + 
  xlab(label = "Frustration") +
  ylab(label = "Level") +
  scale_fill_manual(values=c("red","blue"))+
...
#Proprioception 
  #Histogram
ggplot(dfSummary,aes(Proprioception , fill=Level),xlab=7,ylab=7)+
   scale_fill_manual(values=c("red","blue"))+
   xlab(label = "Proprioception ") +
   ylab(label = "Fequency") +
   geom_histogram(alpha=0.5,bins=14,position="identity")
  #boxplot
ggplot(dfSummary, aes(Proprioception , y=Level, fill=Level)) + 
  coord_flip() + 
  xlab(label = "Proprioception ") +
  ylab(label = "Level") +
  scale_fill_manual(values=c("red","blue"))+
