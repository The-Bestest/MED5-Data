...
SoOCompactPlot <- ggplot(gg2, aes(Level, SoO, colour=Level)) + theme_bw() +
  geom_jitter(data = dfData, aes(Level, SoO), width=0.2, color="black", alpha=0.5, size=1) + 
  geom_point(position=position_dodge(0.2), size=2.5, colour="red") +
  geom_errorbar(aes(ymin=SoO-ci, ymax=SoO+ci), width=.2, position = position_dodge(0.2), color="red") +
