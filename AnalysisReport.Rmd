...
# We are very sorry about this - :-) yes, that hurs ;-) and pairing is not correct iirc
...
# I don't think you can pair your wilcox test because each person only contributes 1 rating for first experience
...
# not sure why you use wilcoxon it's a continuous variable, cand you cannot pair here either
...
t.test(Body2$accPerc, Block2$accPerc)
```
